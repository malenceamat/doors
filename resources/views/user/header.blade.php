        ...
        <div class="container">
            <div class="inner relative">
                ...
                {{--<div class="header-tel">
                    <div class="table">
                        <div class="table-cell">
                            ...
                            @if(Auth::user())
                                <div class="callback-link-wrap text-right-sm">
                                    <a href="{{route ('account_settings')}}" class="wrap-long-word" style="border-bottom: 1px dashed; display: inline-block" >Здравствуйте, {{Auth::user()->name}}</a>
                                </div>
                            @else
                                <div class="callback-link-wrap text-right-sm">
                                    <a href="{{route ('account_settings')}}" class="wrap-long-word" style="border-bottom: 1px dashed" >Вход</a>
                                </div>
                            @endif
                ...
                <div class="header-tel" >
                    <div class="table">
                        <div class="table-cell" >
                            <div class="header-tel-1" style="margin-left: 3em">
                                <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="phone-alt"
                                     role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                     class="svg-inline--fa fa-phone-alt fa-w-16 fa-2x">
                                    <path fill="currentColor"
                            ...
                            @if(Auth::user())
                                    <a href="{{route('account_settings')}}" class="wrap-long-word text-right" style="border-bottom: 1px dashed; display: inline-block">Здравствуйте, {{Auth::user()->name}}</a>
                            @else
                                    <a href="{{route('account_settings')}}" class="wrap-long-word text-right" style="border-bottom: 1px dashed" >Вход</a>
                            @endif
                        </div>
                    </div>
                </div>
