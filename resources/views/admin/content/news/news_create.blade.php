...
@section('news')
    ...
    <div class="profile-image">
        <form @if(isset($news->id)) action="{{route('news_edit')}}" @else action="{{route('news_create')}}" @endif
                ...
                <div class="mb-12">
                    <div class="col-lg-10 col-sm-12 mt-2 pl-0">
                        <input id="itn-croppie-result-i" type="text" hidden value="{{$news['image']}}"
                               name="image">
                        <img id="itn-croppie-result" src="{{asset('/storage/'.$news['image'])}}"
                                            ...
                                            <div class="statbox widget box box-shadow">
                                                ...
                                                <div class="widget-content widget-content-area">
                                                    ...
                                                    <div id="editor-container">
                                                        <label for="hiddenArea">{!! $news['text'] !!}</label>
        ...
        @if(isset($news->id))
            <div class="" style="float: right;height: auto">
                <form method="POST" action="{{route('news_delete', ['id' => $news['id']])}}">
                    @csrf
                    {{method_field('DELETE')}}
